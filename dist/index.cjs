...
function Badge({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("span", { className, style: composed, ...props, children: [
...
var CardBase = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className, style: composed, ...props, children: [
    header != null && /* @__PURE__ */ jsxRuntime.jsx("div", { style: { borderBottom: "1px solid rgb(var(--border))", padding: "16px 20px" }, children: header }),
    /* @__PURE__ */ jsxRuntime.jsx("div", { style: { padding: "16px 20px" }, children }),
    footer != null && /* @__PURE__ */ jsxRuntime.jsx("div", { style: {
...
function Metric({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className, style: { display: "flex", flexDirection: "column", gap: 6, ...style }, ...props, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", alignItems: "baseline", gap: 6 }, children: [
      ...
      unit && /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontFamily: "var(--font-mono)", fontSize: "var(--text-sm)", color: "rgb(var(--fg-muted))" }, children: unit })
    ] }),
    (hasDelta || statusLabel) && /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 10, fontSize: "var(--text-xs)" }, children: [
      hasDelta && /* @__PURE__ */ jsxRuntime.jsxs("span", { style: { fontFamily: "var(--font-mono)", fontWeight: "var(--weight-medium)", color: deltaColor }, children: [
        arrow,
        " ",
        Math.abs(delta),
        deltaSuffix
      ] }),
      statusLabel && /* @__PURE__ */ jsxRuntime.jsxs("span", { style: { display: "inline-flex", alignItems: "center", gap: 5, color: "rgb(var(--fg-muted))" }, children: [
        statusColor && /* @__PURE__ */ jsxRuntime.jsx("span", { style: { width: 6, height: 6, borderRadius: "9999px", background: statusColor } }),
        statusLabel
      ] })
    ] })
  ] });
...
function NavBar({
  ...
  const [togHover, setTogHover] = React.useState(false);
  return /* @__PURE__ */ jsxRuntime.jsx(
    "nav",
    {
      className,
      ...
      children: /* @__PURE__ */ jsxRuntime.jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsxRuntime.jsx("a", { href: "/", style: {
          display: "flex",
          alignItems: "center",
          gap: 8,
          ...
          textDecoration: "none",
          color: "inherit"
        }, children: logo ?? /* @__PURE__ */ jsxRuntime.jsxs("span", { children: [
          "jr",
          /* @__PURE__ */ jsxRuntime.jsx("span", { style: { color: "rgb(var(--color-accent-500))" }, children: "lab" })
        ] }) }),
        /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 4 }, children: [
          links.map((link, i) => /* @__PURE__ */ jsxRuntime.jsx(NavLinkItem, { label: link.label, href: link.href }, link.href ?? String(i))),
          /* @__PURE__ */ jsxRuntime.jsx(
            "button",
            {
              ...
              children: dark ? /* @__PURE__ */ jsxRuntime.jsx(SunIcon, {}) : /* @__PURE__ */ jsxRuntime.jsx(MoonIcon, {})
            }
          )
        ] })
      ] })
